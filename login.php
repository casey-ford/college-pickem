...
<head>
	...
	<title>College Bowl Pick 'Em</title>
...
<body>
	<div class="container">
		<form class="form-signin" role="form" action="login.php" method="POST">
			<h3 class="form-signin-heading">College Bowl Pick 'Em</h3>
			<?php
			//print_r($_POST);
			...
			?>
			<p><input type="text" name="username" class="form-control" placeholder="Email Address" required autofocus />
